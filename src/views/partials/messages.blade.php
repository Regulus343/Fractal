...
@if (isset($sessionMessages['success']) && $sessionMessages['success'] != "")
	<div class="alert alert-success alert-top alert-dismissable">
...
@if (isset($sessionMessages['error']) && $sessionMessages['error'] != "")
	<div class="alert alert-danger alert-top alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
@if (isset($sessionMessages['warning']) && $sessionMessages['warning'] != "")
	<div class="alert alert-warning alert-top alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
<div class="alert alert-warning alert-top alert-dismissable-hide hidden" id="message-warning">
	<button type="button" class="close">&times;</button>
	<div></div>
</div>
...
@if (isset($sessionMessages['info']) && $sessionMessages['info'] != "")
	<div class="alert alert-info alert-top alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
<div class="alert alert-info alert-top alert-dismissable-hide hidden" id="message-info">
	<button type="button" class="close">&times;</button>
	<div></div>
</div>