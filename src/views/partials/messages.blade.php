...
@if (isset($sessionMessages['success']) && $sessionMessages['success'] != "")
	<div class="alert alert-success alert-top alert-transparent alert-dismissable alert-auto-hide">
...
<div class="alert alert-success alert-top alert-transparent alert-dismissable-hide hidden" id="message-success">
...
@if (isset($sessionMessages['error']) && $sessionMessages['error'] != "")
	<div class="alert alert-danger alert-top alert-transparent alert-dismissable alert-auto-hide">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
<div class="alert alert-danger alert-top alert-transparent alert-dismissable-hide hidden" id="message-error">
	<button type="button" class="close">&times;</button>
	<div></div>
</div>
...
@if (isset($sessionMessages['warning']) && $sessionMessages['warning'] != "")
	<div class="alert alert-warning alert-top alert-transparent alert-dismissable alert-auto-hide">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
