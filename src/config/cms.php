	...
	*/
	...
	'controller_methods' => [
		...
		'get'  => [
			...
			'users/permissions/add/{type}/{id}/{permission}'    => 'Regulus\Fractal\Controllers\Users\PermissionsController@add',
			'users/permissions/remove/{type}/{id}/{permission}' => 'Regulus\Fractal\Controllers\Users\PermissionsController@remove',
		],
		...
		'post' => [
			...
			'users/roles/search'                                => 'Regulus\Fractal\Controllers\Users\RolesController@search',
			'users/permissions/search'                          => 'Regulus\Fractal\Controllers\Users\PermissionsController@search',
